...
public class NettyHttpServletPipelineFactory extends ChannelInitializer<Channel> {
    private static final Logger LOG =
        LogUtils.getL7dLogger(org.apache.cxf.transport.http.netty.server.NettyHttpServletPipelineFactory.class);
    ...
    private final ServerEngine nettyHttpServerEngine;
